...
%}
function [OSPA,OSPA_sensor,Num_estimate,Time,Sensor_traj,X_est_series,decision_log] = PROCESS(~,Xreal_time_target,Sensor,N,GridMap,~, sensor, control_opt, process_opt, parallel_opt)
